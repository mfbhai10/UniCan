    ...
    <div className="w-full h-[80px] flex items-center justify-between md:justify-center gap-[30px] px-[20px] fixed top-0 z-[9999] bg-[#fff9f6] overflow-visible">
      ...
      <div className="flex items-center gap-4">
        ...
        {userData.role == "owner" ? (
          <>
            {myShopData && <>
              <button className="hidden md:flex items-center gap-1 cursor-pointer rounded-full bg-[#ff4d2d]/10 text-[#ff4d2d]" onClick={()=>navigate("/add-item")}>
              <FaPlus size={20} />
              <span>Add Food Item</span>
            </button>
            <button className="md:hidden flex items-center cursor-pointer rounded-full bg-[#ff4d2d]/10 text-[#ff4d2d]" onClick={()=>navigate("/add-item")}>
              <FaPlus size={20} />
            </button>
            </>}
            <div className="hidden md:flex items-center gap-2 cursor-pointer relative px-3 py-1 rounded-lg bg-[#ff4d2d]/10 text-[#ff4d2d] font-medium">
              ...
              <span>My Orders</span>
              <span className="absolute -right-2 -top-2 text-xs text-white bg-[#ff4d2d] rounded-full px-[6px] py-[1px]">0</span>
            </div>
