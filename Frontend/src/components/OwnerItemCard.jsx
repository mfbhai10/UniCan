      ...
      <div className="flex flex-col justify-between p-3 flex-1">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 text-[#ff4d2d]">
            <div className="p-2 rounded-full text-[#ff4d2d] hover:bg-[#ff4d2d]/10 cursor-pointer" onClick={()=>navigate(`/edit-item/${data._id}`)}>
                <FaPencilAlt size={16}  />
            </div>
            <div className="p-2 rounded-full text-[#ff4d2d] hover:bg-[#ff4d2d]/10 cursor-pointer" onClick={handleDeleteItem}>
                <FaTrashCan size={16}  />
            </div>
